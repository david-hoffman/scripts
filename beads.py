...
def sub_molarity(diameter, concentration, rho):
    ...
    click.echo(("For a bead diameter of {} um and a concentration of {} "
...
def dilution(diameter, concentration, desired, rho):
    ...
    click.echo("To get a concentration of {} pM you'd need to do a 1:{:.0f} dilution".format(desired, mol/desired))
